	...
	return {
		...
		STRING : {
			username_placeholder : '邮箱/用户名/手机',
  			...
  			'leftmenu_me.go_preferences' : '个人偏好设置',
  			'leftmenu_me.go_account_info' : '账号资料设置',
  			'leftmenu_me.post_feedback' : '提交反馈',
  			'leftmenu_me.link_worktile_app' : '移动端下载',
  			'leftmenu_me.watch_wechat' : '关注微信',
  			'leftmenu_me.link_help' : '帮助',
  			'leftmenu_me.link_club' : '社区',
  			'leftmenu_me.link_blog' : '博客',
  			'leftmenu_me.link_can' : '案例',
  			'leftmenu_me.btn_quit_session' : '退出登录',
  			'common.txt_team': '团队',
