 ...
 define(['error','constant'],function (error,constant,require) {
	...
	return {
		...
		templateUrls : {
			...
			post_main: 'views/work/project/post/posts.html',
			post_toolbar: 'views/work/project/post/toolbar.html',
			page_main: 'views/work/project/page/pages.html',
			page_toolbar: 'views/work/project/page/toolbar.html',
			graph_main: 'views/work/project/graph/grapes.html',
			graph_toolbar: 'views/work/project/graph/toolbar.html',
